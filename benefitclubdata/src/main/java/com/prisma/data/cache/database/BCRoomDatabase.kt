package com.prisma.data.cache.database
...
import com.prisma.data.cache.DATABASE_NAME
import com.prisma.data.cache.converters.BCAddressModelConverter
import com.prisma.data.cache.converters.BCValidationModelConverter
import com.prisma.data.cache.dao.BCAccountDao
...
@Database(entities = [
    ...
    BCCacheModel.BCValidationModel::class
],
        version = 1,
        exportSchema = false)
