package com.prisma.data.local.cache.model

import androidx.annotation.Keep
import androidx.room.*
import com.google.gson.annotations.SerializedName
import com.prisma.data.local.cache.BC_ACCOUNT_TABLE_NAME
import com.prisma.data.local.cache.BC_ADDRESS_TABLE_NAME
import com.prisma.data.local.cache.BC_USER_EMAIL
import com.prisma.data.local.cache.BC_VALIDATIONS_TABLE_NAME
...
@Keep
 object BCCacheModel {
     ...
     data class BCAccountModel(
             ...
             @TypeConverters(BCValidationModelConverter::class)
